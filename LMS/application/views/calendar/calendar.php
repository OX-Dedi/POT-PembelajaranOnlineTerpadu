...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://localhost/POT/LMS/calendarassets/css/bootstrap.min.css">
        <link rel="stylesheet" type="text/css" href="http://localhost/POT/LMS/calendarassets/css/style.css">
        <link rel="stylesheet" type="text/css" href="http://localhost/POT/LMS/calendarassets/font-awesome/css/font-awesome.min.css">
        <link rel="stylesheet" type="text/css" href="http://localhost/POT/LMS/calendarassets/plugins/fullcalendar/fullcalendar.css">
        <link rel="stylesheet" type="text/css" href="http://localhost/POT/LMS/calendarassets/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css">
    </head>
    <body>
    ...
    <script type="text/javascript" src="http://localhost/POT/LMS/calendarassets/js/jquery.min.js"></script>      
    <script type="text/javascript" src="http://localhost/POT/LMS/calendarassets/js/moment.min.js"></script>      
    <script type="text/javascript" src="http://localhost/POT/LMS/calendarassets/js/bootstrap.min.js"></script>      
    <script type="text/javascript" src="http://localhost/POT/LMS/calendarassets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>      
    <script type="text/javascript" src="http://localhost/POT/LMS/calendarassets/plugins/fullcalendar/fullcalendar.js"></script>      
